...
class ExperimentResult(BaseModel):
    ...
    cost_data: dict[str, Any] = Field(
        description="Dictionary containing cost tracking information"
    )
    ...
    def export_inference_results_csv(
        ...
        csv_filename = f"inference_results_{self.experiment_id}.csv"
    ...
    def export_combined_results_json(
        self,
        output_path: Path,
        config_seq: int,
        dataset_seq: int,
        ...
        """
        Export combined inference and evaluation results to a JSON file.
        ...
        json_filename = f"combined_results_{self.experiment_id}.json"
    ...
    def export_all(
        ...
        self.export_combined_results_json(
            output_path, config_seq, dataset_seq, config_name, dataset_id
        )
